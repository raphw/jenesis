...
every step by hand. This is the modular counterpart of `../demo-26-custom-maven`.
...
full `Project` entry point) and `../demo-28-custom-build` (a build wired entirely by
...
entirely and wire the build graph by hand, see `../demo-28-custom-build`.
