...
The modular counterpart of `../custom-maven`: a multi-module **modular** project
...
It sits between `../java-modular-multi` (the same shape of project driven by the
full `Project` entry point) and `../custom-build` (a build wired entirely by
