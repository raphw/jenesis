...
`../demo-09-java-quality`. The `scalafmt` formatter in `../demo-13-scala-quality`
works the same way.
...
the `kotlin.stdlib` the module ships against (see `../demo-10-kotlin`). detekt and
