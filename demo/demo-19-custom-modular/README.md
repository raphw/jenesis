...
every step by hand. This is the modular counterpart of `../demo-18-custom-maven`.
...
full `Project` entry point) and `../demo-20-custom-build` (a build wired entirely by
...
entirely and wire the build graph by hand, see `../demo-20-custom-build`.
