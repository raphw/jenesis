...
every step by hand. This is the modular counterpart of `../demo-23-custom-maven`.
...
full `Project` entry point) and `../demo-25-custom-build` (a build wired entirely by
...
entirely and wire the build graph by hand, see `../demo-25-custom-build`.
