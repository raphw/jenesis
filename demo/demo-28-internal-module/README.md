...
`../demo-29-external-module` runs the identical plugin, but resolves it as a
...
*layout* in `../demo-22-module-layout` is the stricter case: it resolves only by
