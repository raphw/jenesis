...
/**
 * Sibling of {@link Run} that builds a <em>fully bundled native installer</em>
 * rather than a run-in-place app-image. Where {@code Run} packages {@code app-image}
 * (a directory you launch directly), {@code RunNative} packages the platform's
 ...
 *
 * It follows the same shape as {@code Run}: set the packaging type explicitly on
...
public class RunNative {
    ...
    static void main(String[] args) throws Exception {
        ...
        // counterpart to Run's fixed "app-image". Configure it explicitly on the
        // assembler, exactly as Run configures "app-image".
        ...
        // Same fixed target as Run: building `stage` returns a map keyed by the steps that
