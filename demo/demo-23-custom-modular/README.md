...
every step by hand. This is the modular counterpart of `../demo-22-custom-maven`.
...
full `Project` entry point) and `../demo-24-custom-build` (a build wired entirely by
...
entirely and wire the build graph by hand, see `../demo-24-custom-build`.
