...
`../demo-26-internal-module`: same plugin, same outcome, only the plugin is
...
Just as in `../demo-26-internal-module`, the resolved build module is loaded into
