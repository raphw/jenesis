...
every step by hand. This is the modular counterpart of `../demo-31-custom-maven`.
...
full `Project` entry point) and `../demo-33-custom-build` (a build wired entirely by
...
entirely and wire the build graph by hand, see `../demo-33-custom-build`.
