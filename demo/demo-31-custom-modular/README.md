...
every step by hand. This is the modular counterpart of `../demo-30-custom-maven`.
...
full `Project` entry point) and `../demo-32-custom-build` (a build wired entirely by
...
entirely and wire the build graph by hand, see `../demo-32-custom-build`.
