...
contribute a class to a package it does not also define (see `../demo-14-groovy`).

Pinning
-------

The Groovy compiler is pinned in its own `groovyc` group (see `../demo-14-groovy`).
