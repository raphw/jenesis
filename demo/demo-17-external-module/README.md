...
`../demo-16-internal-module`: same plugin, same outcome, only the plugin is
...
Just as in `../demo-16-internal-module`, the resolved build module is loaded into
