...
public class Modules {
    ...
    static void main(String[] args) throws IOException {
        ...
        root.addModule("main", new JavaToolchainModule(), identifier -> identifier.equals("artifacts") ? Optional.of(identifier) : Optional.empty(), "main-artifacts", "main-sources");
        ...
        root.addModule("test", new JavaToolchainModule(), "test-artifacts", "test-sources", "main");
