...
public class InferredSourceCodeQualityModuleTest {
    ...
    public void wires_checkstyle_when_its_config_file_is_present() throws IOException {
        ...
        executor.execute("quality/checkstyle/execution/required");

        Path requiredOutput = root.resolve("quality").resolve("checkstyle").resolve("execution").resolve("required").resolve("output");
