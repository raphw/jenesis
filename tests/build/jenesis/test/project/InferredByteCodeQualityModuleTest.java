...
public class InferredByteCodeQualityModuleTest {
    ...
    public void wires_spotbugs_when_its_filter_file_is_present() throws IOException {
        ...
        executor.execute("quality/spotbugs/execution/required");

        Path requiredOutput = root.resolve("quality").resolve("spotbugs").resolve("execution").resolve("required").resolve("output");
