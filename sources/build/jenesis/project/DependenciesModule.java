...
public class DependenciesModule implements BuildExecutorModule {
    ...
    public static final String RESOLVED = "resolved", ARTIFACTS = "artifacts", PIN = "pin";

    private final Map<String, Repository> repositories;
    private final Map<String, Resolver> resolvers;
    private final boolean compile;
    private final BuildStep pin;
    ...
    public DependenciesModule withPin(BuildStep pin) {
        return new DependenciesModule(repositories, resolvers, compile, pin);
    }
    ...
    public void accept(BuildExecutor buildExecutor, SequencedMap<String, Path> inherited) {
        ...
        if (pin != null) {
            buildExecutor.addStep(PIN, pin, RESOLVED);
        }
    }
}
